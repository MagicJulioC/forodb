...
export class ApiRestService {
  ...
  constructor(private http:HttpClient) { }
    login(email: String, pass: string){
      this.http.post(this.urlLogin,{"email":email,"password":pass,"returnSecureToken":true})
    }
    register(email: string, pass: string){
      this.http.post(this.urlRegister,{"email":email,"password":pass,"returnSecureToken":true})
    }
